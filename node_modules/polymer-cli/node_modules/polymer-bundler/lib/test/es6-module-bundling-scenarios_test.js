...
suite('Es6 Module Bundling', () => {
    test('export from', () => __awaiter(this, void 0, void 0, function* () {
    ...
    suite('rewriting export specifiers', () => {
      ...
      `,
        ...
        test('export specifier is in a bundle', () => __awaiter(this, void 0, void 0, function* () {
            const bundler = new bundler_1.Bundler({ analyzer, strategy: bundle_manifest_1.generateSharedDepsMergeStrategy(2) });
            const { documents } = yield bundler.bundle(yield bundler.generateManifest([aUrl, cUrl]));
            chai_1.assert.deepEqual(documents.get(aUrl).content, test_utils_1.heredoc `
        ...
        test('export specifier is not in a bundle', () => __awaiter(this, void 0, void 0, function* () {
            const bundler = new bundler_1.Bundler({ analyzer, excludes: [bUrl] });
            const { documents } = yield bundler.bundle(yield bundler.generateManifest([aUrl]));
            chai_1.assert.deepEqual(documents.get(aUrl).content, test_utils_1.heredoc `
        export { b } from './b.js';
        var a = {
    ...
    suite('dynamic imports', () => {
        ...
        test('updates external module script src', () => __awaiter(this, void 0, void 0, function* () {
            const analyzer = test_utils_1.inMemoryAnalyzer({
                'index.html': `
        ...
        `,
            ...
            const bundler = new bundler_1.Bundler({ analyzer, inlineScripts: false });
            const manifest = yield bundler.generateManifest([indexUrl]);
            chai_1.assert.deepEqual([...manifest.bundles.keys()], [indexUrl, sharedBundleUrl]);
            const { documents } = yield bundler.bundle(yield bundler.generateManifest([indexUrl]));
            chai_1.assert.deepEqual(documents.get(indexUrl).content, test_utils_1.heredoc `
        <script type="module" src="shared_bundle_1.js"></script>
      `);
            chai_1.assert.deepEqual(documents.get(sharedBundleUrl).content, test_utils_1.heredoc `
        const b = 'b';
        var b$1 = {
          b: b
        };

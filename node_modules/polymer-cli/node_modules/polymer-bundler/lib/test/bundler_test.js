...
suite('Bundler', () => {
    ...
    function getAnalyzer(opts = {}) {
        if (analyzer === undefined) {
            analyzer = new polymer_analyzer_1.Analyzer(Object.assign({ urlResolver: new polymer_analyzer_1.FsUrlResolver(url_utils_1.resolvePath('test/html')), urlLoader: new polymer_analyzer_1.FsUrlLoader(url_utils_1.resolvePath('test/html')) }, opts));
        }
        return analyzer;
    }
    function getBundler(opts) {
        if (bundler === undefined) {
            bundler = new bundler_1.Bundler(Object.assign({ analyzer: getAnalyzer() }, opts));
        }
        return bundler;
    }
    ...
    test('lazy imports are not moved', () => __awaiter(this, void 0, void 0, function* () {
        ...
        const entrypointBundle = documents.getHtmlDoc(resolve('imports/lazy-imports.html')).ast;
        ...
        // is preserved.
        const sharedBundle = documents.getHtmlDoc(resolve('shared_bundle_1.html')).ast;
    ...
    test('Scripts are not inlined if specified', () => __awaiter(this, void 0, void 0, function* () {
        const scripts = dom5.queryAll((yield bundle(resolve('external.html'), { inlineScripts: false })).ast, matchers.externalNonModuleScript);
    ...
    suite('Inline Scripts', () => {
        ...
        test('External script tags are replaced with inline scripts', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const externalScripts = dom5.queryAll(doc, matchers.externalNonModuleScript);
    ...
    suite('Regression Testing', () => {
        ...
        test('eagerly importing a fragment', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const shell = parse5.serialize(result.documents
                .getHtmlDoc(resolve('imports/importing-fragments/shell.html')).ast);

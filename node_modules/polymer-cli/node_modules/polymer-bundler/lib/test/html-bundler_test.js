...
suite('HtmlBundler', () => {
    ...
    test('inline es6 modules with node module-resolution', () => __awaiter(this, void 0, void 0, function* () {
        const root = 'test/html/inline-es6-modules';
        const analyzer = new polymer_analyzer_1.Analyzer({
            urlResolver: new polymer_analyzer_1.FsUrlResolver(root),
            urlLoader: new polymer_analyzer_1.FsUrlLoader(root),
        ...
        const bundler = new bundler_1.Bundler({ analyzer });
        const importUsingNodeModuleResolutionUrl = analyzer.resolveUrl('import-using-node-module-resolution.html');
        const { documents } = yield bundler.bundle(yield bundler.generateManifest([importUsingNodeModuleResolutionUrl]));
        const importUsingNodeModuleResolutionDoc = documents.getHtmlDoc(importUsingNodeModuleResolutionUrl);
        assert.deepEqual(importUsingNodeModuleResolutionDoc.content, test_utils_1.heredoc `
      <script type="module">
      const feature = {
        cool: 'thing'
      };
    ...
    test('inline es6 modules', () => __awaiter(this, void 0, void 0, function* () {
      ...
      `,
        ...
        const multipleInlineBundlesBundleDocument = yield html_bundler_1.bundle(bundler, manifest, multipleInlineBundlesUrl);

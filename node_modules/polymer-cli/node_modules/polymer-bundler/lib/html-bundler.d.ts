...
export declare class HtmlBundler {
     ...
     */
    private _rollupInlineModuleScripts(ast);
    /**
     ...
     */
    private _rewriteExternalModuleScriptTagsAsImports(ast);
    /**

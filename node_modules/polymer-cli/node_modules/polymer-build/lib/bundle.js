...
class BuildBundler extends streams_1.AsyncTransformStream {
    constructor(config, buildAnalyzer, options = {}) {
        ...
        const forkedAnalyzer = (analyzer || buildAnalyzer.analyzer)._fork({ urlLoader });
        if (strategy === undefined && this.config.shell !== undefined) {
            strategy =
                polymer_bundler_1.generateShellMergeStrategy(forkedAnalyzer.resolveUrl(path_transformers_1.urlFromPath(this.config.root, this.config.shell)));
        }

...
suite('TypeScriptParser', function () {
    ...
    suite('parse()', () => {
      ...
      `;
            const document = parser.parse(contents, test_utils_1.resolvedUrl `/typescript/test.ts`, new package_url_resolver_1.PackageUrlResolver());
        ...
        test('throws a WarningCarryingException for parse errors', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const url = test_utils_1.resolvedUrl `ts-parse-error.ts`;
            let error = undefined;
            try {
                parser.parse(contents, url, new package_url_resolver_1.PackageUrlResolver());
            }
            catch (e) {

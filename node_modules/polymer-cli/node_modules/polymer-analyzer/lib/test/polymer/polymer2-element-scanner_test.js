...
namespaced name.`,
    ...
    test('finds multiline observers', () => __awaiter(this, void 0, void 0, function* () {
        const elements = yield getElements('test-element-20.js');
        const elementData = yield Promise.all(elements.map(getTestProps));
        chai_1.assert.deepEqual(elementData, [
            {
                ...
                observers: ['_testObserver(prop1, prop2)', '_testObserverTwo(prop1, prop2)'],
                properties: [

...
suite('Polymer2MixinScanner', () => {
    ...
    suiteSetup(() => __awaiter(this, void 0, void 0, function* () {
        const testFilesDir = path.resolve(test_utils_1.fixtureDir, 'polymer2/');
...
~~`);
    ...
    test('finds exported mixin functions', () => __awaiter(this, void 0, void 0, function* () {
        const mixins = yield getScannedMixins('test-mixin-12.js');
        const mixinData = yield Promise.all(mixins.map(getTestProps));
        chai_1.assert.deepEqual(mixinData, [
            {
                name: 'TestMixin',

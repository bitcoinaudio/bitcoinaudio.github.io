...
suite('HtmlElementReferenceScanner', () => {
    test('finds element references', () => __awaiter(this, void 0, void 0, function* () {
      ...
      <body>
        ...
        const { features } = yield test_utils_1.runScannerOnContents(new html_element_reference_scanner_1.HtmlElementReferenceScanner(), 'test-document.html', contents);
...
suite('HtmlCustomElementReferenceScanner', () => {
    test('finds custom element references', () => __awaiter(this, void 0, void 0, function* () {
        ...
        const { features: untypedFeatures, analyzer } = yield test_utils_1.runScannerOnContents(new html_element_reference_scanner_1.HtmlCustomElementReferenceScanner(), 'test-document.html', contents);
        ...
        const attrNameRanges = yield Promise.all(features.map((f) => __awaiter(this, void 0, void 0, function* () {
            return yield underliner.underline(Array.from(f.attributes.values()).map((a) => a.nameSourceRange));
        })));
